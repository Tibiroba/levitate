...
<div class="content">
  ...
  <div class="row">
   ...
   -->
      ...
      <div class="boxSaltando" style="float:left; margin:95px 0px 0px 100px; ">
      ...
      <span class="textBlue fontXl">todos os odores corporais</span>
        ...
        <button class="btn btnPink" style="margin:0 auto; margin-left:100px; margin-bottom:10px;">Experimente</button>
      </div>
  ...
  <div class="row " style=" min-height:139dvh; padding-top:90px;">
      <div class="col-6  p-0">
  ...
  <div class="row ">
        ...
        <div class="col-7">
          <ul class="customList">
            ...
            <li>
            <button class="btn btnPink " style="margin: 86px 0 0 80px;">Experimente</button>
            </li>
