<footer id="footer greyBg">
 ...
 <div class="row " style="padding: 5% 0; ">
         ...
         <p class="fontBig text-center">Siga nas Redes Sociais</p>
         <ul class="listaIcons" style="list-style-type: none; padding:0; justify-content:center;">
            <li style="width: auto;"><a href="https://www.instagram.com/meulevitate/" target="_blank"><img style="max-width: 20px;" src="<?php echo get_stylesheet_directory_uri();?>/img/ICONE_INSTAGRAM.png" alt="ICONE_INSTAGRAM.png"></a></li>
            <li style="width: auto;"><img style="max-width:20px;" src="<?php echo get_stylesheet_directory_uri();?>/img/TIKTOK.png" alt="TIKTOK.png"></li>
            <li style="width: auto;"><img style="max-width:20px;" src="<?php echo get_stylesheet_directory_uri();?>/img/FACEBOOK.png" alt="FACEBOOK.png"></li>
            <li style="width: auto;"><img style="max-width:20px;" src="<?php echo get_stylesheet_directory_uri();?>/img/YOUTUBE.png" alt="YOUTUBE.png"></li>
         </ul>
         <p class="text-center greyText">Levitate Cosméticos e Artigos LTDA</p>
            <p class="text-center greyText">CNPJ: 58.068.912/0001-85</p>
            <p class="text-center greyText">Todos os direitos reservados</p>
            
         </div>
         
         <div class="col-6 text-center">
      
         <ul style="list-style-type: none; padding:0; text-align:center; height:80%; display:flex; flex-direction:column; justify-content:space-evenly;">
              <li class="font-large"><a style="color:black;" href="<?php echo get_permalink( get_page_by_path( 'manual-levitate' ) ); ?>">Manual Levitate</a></li>
               <li class="font-large"><a style="color:black;" href="<?php echo get_permalink( get_page_by_path( 'duvidas-frequentes' ) ); ?>">Dúvidas Frequentes</a></li>
               <li class="font-large"><a style="color:black;" href="<?php echo get_permalink( get_page_by_path( 'contato' ) ); ?>">Contato</a></li>
               <li class="font-large"><a style="color:black;" href="<?php echo get_permalink( get_page_by_path( 'Embaixadores' ) ); ?>">Embaixadores</a></li>
               <li class="font-large"><a style="color:black;" href="<?php echo get_permalink( get_page_by_path( 'termos-e-condicoes' ) ); ?>">Termos e Condições</a></li>
            </ul>
