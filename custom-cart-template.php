                            ...
                            <div class="cart-item d-flex align-items-center mb-3">
                                ...
                                <div class="product-details flex-grow-1 ms-3">
                                    <ul class="cartListDetails">
                                        <li><p class="product-name "><a class="textPink fontNormal" href="<?php echo esc_url( $product_permalink ); ?>"><?php echo esc_html( $product_name ); ?></a></p>  </li>
                                        <li><p class="product-price greyText">Preço: <?php echo $product_price; ?></p></li>
                                        <li>
    <div class="product-quantity greyText">
        ...
        <form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" class="update-quantity-form d-inline">
            ...
            <?php wp_nonce_field( 'woocommerce-cart', 'woocommerce-cart-nonce' ); ?>
                                        ...
                                        <li><p class="product-subtotal greyText">Subtotal: <?php echo $product_subtotal; ?></p></li>
                                    </ul>
