...
<body <?php body_class(); ?>>
  <header id="header">
    ...
    <nav class="navbar navbar-expand-md w-100 <?php echo is_front_page() ? 'bg-transparent' : 'bg-customBlue'; ?>" id="navbarsExampleDefault" >




      <div class="navbar-toggler navbarMobile <?php echo is_front_page() ? '' : 'bg-customBlue'; ?>" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="navbarMobile p-0 ">
          ...
          <li><a href="<?php echo get_permalink(get_page_by_path('minha-conta')); ?>"><svg class="headerIconsMobile" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4.74 4.74">
                <defs></defs>
          ...
          <li><a href="<?php echo esc_url(wc_get_cart_url()); ?>"><svg class="headerIconsMobile" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.92 33.51">
                <defs>
                  <style>
                    .cls-1 {
                      fill: #e9f8ff;
                ...
                <g id="Layer_2" data-name="Layer 2">
                  <g id="_1" data-name="#1">
                    ...
                    <span class="cartCount font-xsmall textWhite" style="top: -40px;
    right: -13px;"><?php echo WC()->cart->get_cart_contents_count(); ?></span>
                  </g>
                </g>
              </svg></span>
            </a>
          ...
          <li><span class="navbar-toggler-icon">
              <svg xmlns="http://www.w3.org/2000/svg" class="headerIconsMobile" viewBox="0 0 4.33 3.89">
                <defs>
                  <style>
                    .cls-1 {
                      fill: #e9f8ff;
        ...
        <ul class="navbar-nav">
          ...
          ?>
            ...
            <li class="nav-item">
              ...
              <a class="nav-link font-xlarge" href="/">Inicio</a>
            </li>
            <li class="nav-item">

              <a class="nav-link font-xlarge" href="<?php echo get_permalink(wc_get_page_id('shop')); ?>">Todos os produtos</a>
            </li>

            <li class="nav-item active">
              <a class="nav-link font-xlarge" style="color:black !important" href="<?php echo get_permalink(get_page_by_path('agua-micelar-corporal')); ?>">Água Micelar Corporal<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link font-xlarge" style="color:black !important" href="<?php echo get_permalink(get_page_by_path('lencos-levitate')); ?>">Lenços Levitate</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font-xlarge" style="color:black !important" href="<?php echo get_permalink(get_page_by_path('neutralizador-textil')); ?>">Neutralizador Têxtil</a>
            </li>
            <li class="nav-item">
              <a class="nav-link font-xlarge" style="" href="<?php echo get_permalink(get_page_by_path('manual-levitate')); ?>">Manual Levitate</a>
            </li>

            <li class="nav-item">
              <a class="nav-link font-xlarge" style="" href="<?php echo get_permalink(get_page_by_path('sobre-nos')); ?>">Sobre Nós</a>
            </li>
  ...
  document.addEventListener('click', function(event) {
    ...
    const closeButton = document.querySelector('.navbar-brand .fa-times'); 
