...
<hr class="headerLine"><!-- Optional cart icon -->
          ...
          <li class="nav-item active">
            <a class="nav-link" style="font-size:1.75rem;" href="#">PRODUTOS<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="font-size:1.75rem;" href="#">DICAS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="font-size:1.75rem;" href="#">SOBRE NÓS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" style="font-size:1.75rem;" href="#">MINHA CONTA</a>
          </li>
