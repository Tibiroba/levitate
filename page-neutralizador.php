...
<h2 class="textBlue  ">Neutralizador Têxtil 500ml</h2>
            <p class="fontNormal">O <b>Neutralizador Têxtil Levitate</b> é um produto em spray (não aerosol), que ao ser aplicado, <b>previne</b> maus odores, como <b>chulé, cecê e cheiro de mofo, em roupas, calçados e acessórios têxteis.</b></p>
            <p class="fontNormal">Além de mantê-los <b>cheirosos</b> por muito mais tempo. O Neutralizador Levitate ajuda a <b>reduzir lavagens desnecessárias, economiza produtos de limpeza e prolonga a durabilidade dos tecidos.</b></p>
            <h4 class="textPink">O Neutralizador Levitate pode ser usado em quais vestuários?</h4>
            <p class="fontNormal">Pode ser usado em roupas, calçados e acessórios têxteis, como <b>blusas, camisas, roupas de academia, bonés, calças, sandálias, tênis, meias e muito mais!</b></p>
            <h4 class="textPink">Qual a causa dos odores nos Vestuários?</h4>
          
            <p class="fontNormal">Todos temos vestuários que tendem a ter mais odores, como, por exemplo, roupas de academia e tênis.</p>
            <p class="fontNormal">Isso acontece porque <b>bactérias e fungos</b> causadores de odor aderem-se fortemente às fibras dos tecidos (principalmente em <b>malhas sintéticas e nas costuras de roupas de algodão)</b> formando uma camada protetora, chamada <b>biofilme</b>, que não é removida com a lavagem convencional.</b></p>
            <h4 class="textPink">Como o Neutralizador Levitate previne odores em tecidos?</h4>
            <p class="fontNormal">O Neutralizador Levitate possui o ativo <b>Ácido Lático</b> que tem a propriedade de inativar os biofilmes e os micro-organismos causadores de odores nos tecidos. Isso garante frescor e proteção prolongada para os vestuários.</p>
            <p class="fontNormal">Sua fórmula <b>feita exclusivamente com componentes cosméticos</b>, é clinicamente segura, sendo <b>dermatologicamente testada e hipoalergênica.</b></p>
            <h4 class="textPink">Modo de Usar:</h4>
            <div class="comoUsar w-100">
            <ul class="listaUse">
                <li class="fontNormal">Pendure o seu vestuário, de preferência, seco e limpo.</li>
                <li class="fontNormal">Borrife o <b class="textBlue">Neutralizador Levitate</b> a uma distância de 30 cm e umedeça uniformemente o tecido;</li>
                <li class="fontNormal">Aguarde a secagem e está pronta para o uso.</li>
            </ul>
            </div>
            
            <h4 class="textPink">Limitações do uso:</h4>
            <ul>
                <li><p class="fontNormal">Não utilize em roupas íntimas e trajes de banho.</p></li>
                <li><p class="fontNormal">Reaplique o produto somente após lavar o vestuário.</p></li>
                <li><p class="fontNormal">Indicado para todos os tipos de tecido exceto: vinil, seda, camurça ou couro.</p></li>
            </ul>
        ...
        <p class="fontNormal">Mais informações em: <a href="<?php echo get_permalink( get_page_by_path( 'manual-levitate' ) ); ?>">Manual Levitate</a> e <a href="<?php echo get_permalink( get_page_by_path( 'duvidas-frequentes' ) ); ?>">Dúvidas Frequentes</a></p>
        
            <div class="comoUsar">
                <p class="fontNormal textPink"><b>Composição :</b></p>
                <p class="fontNormal">ÁGUA, GLICERINA, ÁCIDO LÁTICO, POLISORBATO 20, SORBATO DE POTÁSSIO, EDETATO DISSÓDICO, ESSÊNCIA</p>
            </div>

            <p class="fontNormal textPink">Nossos Selos</p>
